...
int64_t GetProofOfWorkReward(int nBits, int64_t nFees, int nHeight)
{
    if(!fTestNet)
    {
        if(nHeight == 1)
    ...
    printf("nHeight = %d, diff = %f, reward = %ld", nHeight, dDiff, nSubsidy + nFees);
...
unsigned int GetNextTargetRequired(const CBlockIndex* pindexLast, bool fProofOfStake)
{
    ...
    if (pindexLast == NULL || (pindexLast->nHeight < 100 && fTestNet))
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    if (IsProofOfWork())
    {
        int64_t nReward = GetProofOfWorkReward(pindex->pprev->nBits,nFees, pindex->nHeight);
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("f7a4d1c2a037ad5a8669234b04e08e5636080b54145807ab78d2b0253f72029c"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0x77, 0x32, 0x22, 0x02 };
